// enum symtab_type { symtab_none = 0, symtab_file, symtab_entry, symtab_line  };
enum symtab_type { symtab_any = -1, symtab_none = 0, symtab_file=1, symtab_proc=2, symtab_line=4  };
