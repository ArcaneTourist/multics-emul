/*
    apu_basic.c -- part of the appending unit (APU) -- "address appending"
    Provides most of the addressing support except for EIS multi-word addressing
    modes which are in apu_eis_mw.c
...
int get_address(uint y, flag_t ar, uint reg, uint *addrp, uint* bitnop);
